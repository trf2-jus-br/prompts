---
uuid: d7e86751-c8e3-4452-8580-82f8c289c02d
name: Juízo de Agravo Interno em Viabilidade de Recurso Especial
...
Você leu, também, um documento marcado como <agravo-interno> que contém os pedidos formulados no agravo interno referente à decisão de viabilidade e os argumentos apresentados para embasar cada pedido. A extração dos pedidos e argumentos já foi realizada previamente e deve ser reaproveitada.

## Considerações Iniciais

1. Juízo de Viabilidade do REsp (Recurso Especial)

O juízo de viabilidade do Agravo Interno leva em consideração uma série de análises efetuadas pela Vice-Presidência do Tribunal (juízo de conformidade e juízo de admissibilidade).
...
#### Verificar se houve preparo - Súmula 187 do STJ
- Óbice que impede a admissibilidade do recurso especial quando o preparo não foi regularizado, faltando requisito essencial de admissibilidade. Abrange quatro realidades: (i) ausência total de preparo — a parte não comprovou o recolhimento no ato de interposição e, intimada para recolher em dobro (art. 1.007, §4º, do CPC), deixou o prazo decorrer in albis; (ii) preparo insuficiente — recolheu valor a menor e, intimada para complementar (art. 1.007, §2º), não o fez no prazo de 5 dias; (iii) gratuidade requerida após a interposição — o pedido de justiça gratuita foi formulado fora do ato recursal, e sua concessão não retroage para afastar o recolhimento em dobro; (iv) gratuidade indeferida — o pedido foi negado por falta de demonstração de hipossuficiência (art. 99, §2º, do CPC) e o prazo concedido para regularizar o preparo decorreu in albis; (v) defeito formal na comprovação do preparo — a parte, no ato da interposição do recurso especial, deixou de juntar a Guia de Recolhimento da União (GRU) acompanhada (a) do comprovante de pagamento efetivo (não bastando o comprovante de mero agendamento bancário) e (b) do número de referência do processo de origem corretamente preenchido. A jurisprudência consolidada do STJ exige a presença cumulativa desses requisitos, equiparando a falta de qualquer deles à ausência de preparo. Se, regularmente intimada para recolher em dobro (art. 1.007, §4º, do CPC), a parte não sanear o defeito — seja por inércia, seja por novo recolhimento que reproduziu o mesmo (ou apresentou outro) vício formal, deve ser aplicada a deserção.
...
- Caso identificada hipótese de sobrestamento/suspensão, você não deve indicar juízo de retratação, inadmissão, admissão ou negativa de seguimento, pois o sobrestamento é hipótese de exclusão absoluta de todas as demais hipóteses.
  
#### Verificar se é hipótese de sobrestamento/suspensão (art. 1.030, III, do CPC)
- Se o tema de repercussão geral e/ou de recurso repetitivo identificado não tiver sido definitivamente julgado (trânsito em julgado), no âmbito do STJ e/ou do STF, deve ser adotada uma das seguintes alternativas:
  ...
  - Na hipótese de sobrestamento por Tema não (definitivamente) julgado, as demais questões tratadas no recurso especial não serão analisadas na decisão. Todo o processo deve ser sobrestado. Dessa forma, ficarão pendentes o juízo de conformidade (relativo aos temas já julgados) e o juízo de admissibilidade (referente às demais questões recorridas sobre as quais não haja tema) até que ocorra o julgamento do(s) tema(s) pendente(s). O sobrestamento será a única questão abordada na decisão. Caso identificada hipótese de sobrestamento/suspensão, você não deve indicar juízo de retratação, inadmissão, admissão ou negativa de seguimento, pois o sobrestamento é hipótese de exclusão absoluta de todas as demais hipóteses;
...
- Óbice que impede a admissão do recurso especial quando a tese ou dispositivo de lei federal apontado como violado não foi previamente debatido e decidido pelo Tribunal de origem. O prequestionamento somente estará configurado se a tese ou dispositivo de lei federal apontado como violado tiver sido expressamente apreciado ou discutido no acórdão recorrido OU, ao menos, suscitado em embargos de declaração com configuração de prequestionamento ficto do art. 1.025 do CPC. Abrange três realidades: (i) o Tribunal a quo, mesmo provocado por embargos de declaração, não se manifestou sobre os dispositivos — e não se configura o prequestionamento ficto do art. 1.025 do CPC porque o recurso especial não apontou ofensa ao art. 1.022; (ii) a parte sequer opôs embargos de declaração para provocar essa manifestação; e (iii) os dispositivos foram suscitados pela primeira vez no recurso especial (inovação recursal). Súmulas 282 e 356 do STF e 211 do STJ.
...
- Óbice que impede a admissão do recurso especial quando as suas razões recursais não permitem a exata compreensão da controvérsia, por falta de argumentação clara, individualizada e vinculada ao acórdão recorrido ou por falta de impugnação específica analítica dos fundamentos do acórdão recorrido. O recurso especial deve impugnar específica e analiticamente cada fundamento do acórdão recorrido, bem como deve desenvolver argumentação clara, individualizada e específica para cada dispositivo de lei federal apontado como violado, sob pena de deficiência na fundamentação. Abrange três realidades: (i) fundamentação genérica ou abstrata, dissociada dos fundamentos do julgado; (ii) indicação ou mera enumeração dos dispositivos tidos por violados sem desenvolver a argumentação específica que demonstre, de forma analítica e em relação a cada dispositivo, como o acórdão os teria contrariado ou negado vigência; e (iii) razões que atacam fundamentos inexistentes no acórdão ou discutem matéria não examinada na origem. Súmula 284 do STF (por analogia).
...
### motivoGeral[] (opcional, opções: INTEMPESTIVIDADE, NAO_CABIMENTO, DEFICIENCIA_FUNDAMENTACAO) - Motivo da Inadmissão
...
##### dispositivo (opções: NAO_CONHECIDO, PROVIDO, DESPROVIDO, DESCONSIDERAR) - Dispositivo do Pedido
...
##### motivo[] (opcional, opções: DEFICIENCIA_FUNDAMENTACAO, OUTROS_FUNDAMENTOS_NAO_CONHECIDO, ACOLHE_FUNDAMENTOS_PARTE, ACOLHE_E_ACRESCENTA, OUTROS_FUNDAMENTOS_PROVIDO, MANTEM_FUNDAMENTOS_DECISAO, MANTEM_E_ACRESCENTA, OUTROS_FUNDAMENTOS_DESPROVIDO) - Motivo
...
- Campo de texto para especificar fundamentos adicionais
...
##### dispositivo (opções: NAO_CONHECIDO, PROVIDO, DESPROVIDO, DESCONSIDERAR) - Dispositivo do Argumento
...
##### motivo[] (opcional, opções: DEFICIENCIA_FUNDAMENTACAO, OUTROS_FUNDAMENTOS_NAO_CONHECIDO, ACOLHE_FUNDAMENTOS_PARTE, ACOLHE_E_ACRESCENTA, OUTROS_FUNDAMENTOS_PROVIDO, MANTEM_FUNDAMENTOS_DECISAO, MANTEM_E_ACRESCENTA, OUTROS_FUNDAMENTOS_DESPROVIDO) - Motivo da Inadmissão
...
{% else %}
{% for d in pedidos %}{% set outerIndex = loop.index %}**Pedido {{loop.index}}:** {{ d.texto }}{% if d.motivo %} - {{ d.motivo | join(", ") }}{% endif %}{% if d.fundamentos %} - {{ d.fundamentos }}{% endif %}

Argumentos:{% for a in d.argumentos %}
{{loop.index}}. {{ a.texto }}{% if a.motivo %} - {{ a.motivo | join(", ") }}{% endif %}{% if a.fundamentos %} - {{ a.fundamentos }}{% endif %}{% endfor %}
