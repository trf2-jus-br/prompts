---
uuid: 45cc7928-7c4e-4a0d-9cd2-500e45f27f12
name: Minuta de Voto de Agravo Interno em Viabilidade de Recurso Especial
description: Gere minutas fundamentadas de voto em agravo interno em decisão de viabilidade de recurso especial.
sort: 1
share: beta-teste
piece_strategy: agravo-interno-em-viabilidade-recurso-especial
...
predecessors:
  ...
  - path: juizo-agravo-interno-em-viabilidade-recurso-especial
successors:
  - path: ementa
    optional: true
...
* **Perspectiva e voz (juízo de admissibilidade, não Tribunal Superior):** Quem redige é a Vice-Presidência deste Tribunal, no exercício do juízo prévio de admissibilidade/conformação dos recursos excepcionais — nunca o STJ ou o STF. Disso decorre:
  - STJ e STF sempre em terceira pessoa.** Refira-se a eles pelo nome ou por designação neutra — "o Superior Tribunal de Justiça", "o STJ", "o Supremo Tribunal Federal", "o STF", "a Corte Superior", "o Tribunal Superior" —, nunca com o demonstrativo "este"/"esta". São incorretas, e devem ser substituídas, construções como "este Tribunal Superior tem o entendimento...", "esta Corte Superior firmou..." ou "este Superior Tribunal já decidiu...", que fazem o redator falar como se fosse ministro do STJ. Escreva, por exemplo, "o STJ firmou o entendimento de que..." ou "segundo a jurisprudência do Superior Tribunal de Justiça...".
  - Este Tribunal" e "esta Corte" designam apenas o tribunal recorrido. O acórdão impugnado é do próprio Tribunal; por isso, jamais o trate como "acórdão do tribunal de origem", "decisão do Tribunal a quo" ou "Corte de origem" — expressões que adotam o ponto de vista externo do STJ sobre o tribunal recorrido. Use "o acórdão recorrido" ou "o órgão julgador".
  - Papel de conformação. A decisão apenas verifica se o acórdão recorrido está ou não em conformidade com a orientação do STJ/STF: descreva essa orientação em terceira pessoa e confronte-a com o julgado, sem em nenhum momento enunciá-la como se fosse jurisprudência do próprio prolator. Esta regra prevalece sobre a literalidade dos textos-padrão do Módulo 3 — onde algum deles empregar "desta Corte Superior" ou equivalente, ajuste para a terceira pessoa ("da Corte Superior", "do STJ").
...
```
Cinge-se a controvérsia a [definir os termos da controvérsia de MÉRITO objeto do recurso especial].
...
Embora o recurso tenha sido interposto exclusivamente com fundamento na alínea 'a' do permissivo constitucional, o óbice da Súmula n. 83 do Superior Tribunal de Justiça a ele se aplica igualmente. A jurisprudência do Superior Tribunal de Justiça é firme no sentido de que o enunciado sumular incide tanto sobre a alínea 'c' quanto sobre a alínea 'a', sendo suficiente para obstar o recurso especial quando a pretensão da parte recorrente contrariar o entendimento consolidado do Superior Tribunal de Justiça sobre a interpretação da lei federal invocada.
