...
- Em um parágrafo, repita o texto do pedido conforme listado no documento. Inicie com "**Ponto Controvertido [índice do ponto controvertido começando por 1]**: " seguido do texto do ponto controvertido.
...
Comece sua resposta diretamente com "**Ponto Controvertido 1**: ...", sem introduções ou explicações adicionais.