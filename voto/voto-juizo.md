...
Você leu diversos documentos de um processo judicial.
...
O juízo leva em consideração uma série de análises efetuadas.
...
Há hipóteses que podem levar à inadmissibilidade do recurso e que devem ser analisadas antes mesmo da conformidade. São seis verificações iniciais principais:
...
Passa-se ao juízo de mérito quando: (i) não houver tema de repercussão geral ou de recurso repetitivo sobre as questões recorridas; ou (ii) quando às demais questões não são abrangidas por tema.
Não se chega a esta etapa nas hipóteses de sobrestamento, que encerram a decisão.
Para que o mérito seja apreciado, não deve haver tema que imponha sobrestamento, provimento ou negativa de provimento, nem qualquer hipótese de inadmissão.
...
##### motivo[] (opcional, opções: DEFICIENCIA_FUNDAMENTACAO) - Motivo da Inadmissão
