...
Você receberá os textos de peças processuais e um JSON que contêm os pedidos formulados em uma ação cível de primeiro grau.
...
No final, acrescente o título "**Conclusão**" seguido de uma quebra de parágrafo e um parágrafo conclusivo resumindo a importância das teses e súmulas encontradas para a procedência ou improcedência dos pedidos como um todo. Neste último parágrafo, destaque em negrito os pontos mais relevantes.
